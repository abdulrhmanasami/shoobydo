ACCESS_TOKEN_LEEWAY = 120  # seconds
...
def get_bearer_token(cred: HTTPAuthorizationCredentials | None = Depends(oauth2_scheme),
                     authorization: str | None = Header(default=None)) -> str:
    if cred and getattr(cred, "scheme", "").lower() == "bearer" and cred.credentials:
